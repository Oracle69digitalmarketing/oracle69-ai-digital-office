...
export class ProcurementController {
  ...
  async createSupplier(@Req() req: any, @Body() data: any) {
    const orgId = req.user.organizationId;
    return this.runInTenant(orgId, () => this.procurementService.createSupplier({ ...data, organizationId: orgId }));
  }
  ...
  async createPurchaseOrder(@Req() req: any, @Body() data: any) {
    const orgId = req.user.organizationId;
    return this.runInTenant(orgId, () => this.procurementService.createPurchaseOrder({ ...data, organizationId: orgId }));
  }
  ...
  async updatePurchaseOrder(@Req() req: any, @Param('id') id: string, @Body() data: any) {
    const orgId = req.user.organizationId;
    return this.runInTenant(orgId, () => this.procurementService.updatePurchaseOrder(id, { ...data, organizationId: orgId }));
  }
}

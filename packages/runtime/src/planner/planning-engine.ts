...
export class PlanningEngine implements IPlanningEngine {
   ...
   */
  public async validatePlan(plan: ExecutionPlan): Promise<{ valid: boolean; errors?: string[] }> {
    const errors: string[] = [];
   ...
   */
  private async decomposeGoal(goal: string): Promise<TaskDefinition[]> {

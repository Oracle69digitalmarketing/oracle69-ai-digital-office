...
export class HrController {
  ...
  hireEmployee(@Param("organizationId") organizationId: string, @Body() body: any) {
    return this.tenantContext.run({ tenantId: organizationId }, () =>
  ...
  offboardEmployee(@Param("organizationId") organizationId: string, @Param("id") id: string) {
    return this.tenantContext.run({ tenantId: organizationId }, () =>
      this.employeeService.offboardEmployee(id, organizationId),
    );
  }
  ...
  createPosition(@Param("organizationId") organizationId: string, @Body() body: any) {
    return this.tenantContext.run({ tenantId: organizationId }, () =>
  ...
  closePosition(@Param("organizationId") organizationId: string, @Param("id") id: string) {
    return this.tenantContext.run({ tenantId: organizationId }, () =>
      this.recruitmentService.closePosition(id, organizationId),
    );
  }
  ...
  createCandidate(@Param("organizationId") organizationId: string, @Body() body: any) {
    return this.tenantContext.run({ tenantId: organizationId }, () =>
  ...
  hireCandidate(@Param("organizationId") organizationId: string, @Param("id") id: string) {
    return this.tenantContext.run({ tenantId: organizationId }, () =>
      this.recruitmentService.hireCandidate(id, organizationId),
    );
  }
}

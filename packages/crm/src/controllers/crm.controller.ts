...
export class CrmController {
  ...
  createOrganization(@Req() req: any, @Body() dto: CreateCrmOrganizationDto) {
    ...
    return this.runInTenant(orgId, () =>
      this.organizationService.createOrganization({ ...dto, organizationId: orgId }),
    );
  }
  ...
  createContact(@Req() req: any, @Body() dto: CreateCrmContactDto) {
    const orgId = req.user.organizationId;
    return this.runInTenant(orgId, () =>
      this.contactService.createContact({ ...dto, organizationId: orgId }),
    );
  }
  ...
  createLead(@Req() req: any, @Body() dto: CreateCrmLeadDto) {
    const orgId = req.user.organizationId;
    return this.runInTenant(orgId, () =>
      this.leadService.createLead({ ...dto, organizationId: orgId }),
    );
  }
  ...
  createOpportunity(@Req() req: any, @Body() dto: CreateCrmOpportunityDto) {
    const orgId = req.user.organizationId;
    return this.runInTenant(orgId, () =>
      this.opportunityService.createOpportunity({ ...dto, organizationId: orgId }),
    );
  }
  ...
  createActivity(@Req() req: any, @Body() dto: CreateCrmActivityDto) {
    const orgId = req.user.organizationId;
    return this.runInTenant(orgId, () =>
      this.activityService.createActivity({ ...dto, organizationId: orgId }),
    );
  }

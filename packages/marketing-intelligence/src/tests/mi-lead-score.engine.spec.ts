  ...
  it("should score leads, update CRM, persist scores and detect opportunities", async () => {
    mockOrganization([
      ...
      lead({
        ...
        source: "paid",
        status: "new",
        crmOrganization: { revenue: 100000, healthScore: 80 },
        activities: [{}],
      }),
      lead({
        id: "l3",
      ...
      lead({
        ...
        source: "paid",
        status: "converted",
        crmOrganization: { revenue: 100000, healthScore: 60 },
        activities: [{}],
      }),
    ]);
    ...
    expect(messageBus.publish).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        payload: expect.objectContaining({
          opportunities: expect.arrayContaining([expect.objectContaining({ leadId: "l3" })]),
        }),
      }),
    );
  });

...
export class MarketingIntelligenceController {
  ...
  createCampaign(@Param('organizationId') organizationId: string, @Body() body: CampaignCreateInput) {
  ...
  getCampaignMetrics(@Param('organizationId') organizationId: string, @Query('period') period?: string) {
  ...
  generateInsights(@Param('organizationId') organizationId: string, @Query('period') period?: string) {
  ...
  generateReport(@Param('organizationId') organizationId: string, @Query('period') period?: string) {

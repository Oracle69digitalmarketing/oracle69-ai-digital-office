import { KnowledgeArticle, KnowledgeArticleStatus, KnowledgeSearchResult, KnowledgeKpis, KnowledgeHealth, KnowledgeReport, KnowledgeRecommendation, KnowledgeAiInsight } from '@oracle69/knowledge-intelligence/src/types';

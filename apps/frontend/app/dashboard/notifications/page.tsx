...
const notifications = [
  {
    id: 1,
    type: "info",
    title: "New Task Routed",
    message: "AI Receptionist has routed a new task: 'Acme Corp Proposal'.",
    time: "5 minutes ago",
    read: false,
  },
  {
    ...
    message: "Project 'Nexus Infrastructure' is nearing its deadline in 48 hours.",
    time: "1 hour ago",
    read: false,
  },
  {
    ...
    message: "Monthly financial report for June 2026 has been successfully generated.",
    time: "2 hours ago",
    read: true,
  },
  {
    ...
    type: "info",
    title: "System Update",
    message: "Oracle69 AI core has been updated to v2.4.5. Check the changelog for details.",
    time: "5 hours ago",
    read: true,
  },
  {
    ...
    message: "Global Tech has completed the onboarding process.",
    time: "1 day ago",
    read: true,
  },
];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">
            Stay updated with your AI organization's latest activities.
          </p>
        </div>
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <h3
                    className={cn(
                      "text-sm font-bold",
                      notif.read ? "text-gray-900" : "text-indigo-900",
                    )}
                  >
                    {notif.title}
                  </h3>
                ...
                {!notif.read && (
                  <div className="mt-3 flex space-x-4">
                    ...
                    <button className="text-xs font-bold text-gray-400 hover:text-gray-500">
                      Archive
                    </button>
                  </div>
                )}

...
This ensures that on _every_ successful deployment, Prisma verifies/updates the database schema before starting the application, solving the P2021 error without requiring migration files.
